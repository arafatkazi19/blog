...
<div class="row">
    <div class="col-md-offset-2 col-md-8">
        ...
        <div class="well">
            <h3 class="text-center text-success">Edit Blog</h3>
            <hr>
            ...
            <form action="{{route('update-blog')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea type="text" name="blog_short_description" class="form-control" rows="5" cols="30">{{$blog->blog_short_description}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Blog Long Description</label>
                    <div class="col-md-9">
                        <textarea type="text" id="editor" name="blog_long_description" class="form-control" rows="5" cols="30">{{$blog->blog_long_description}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 radio">
                        ...
                        <label><input type="radio" name="publication_status" {{$blog->publication_status==0 ? 'checked' : ' '}} value="0" >Unpublished</label><br>
